 ...
 */
int absVal(int x) {
  int s=(x>>31);// if x is negetive, s=0xffffffff; else s=0
  return (s^x)+!!s;
}
/*
...
unsigned float_abs(unsigned uf) {
  unsigned p1=0x7f800000;
  unsigned p2=0x7fffffff;
  unsigned p3=uf&p2;
  if (p3>p1) return uf;
  return p3;
}
...
int float_f2i(unsigned uf) {
  ...
  if (e>31||((uf&(0x7fffffff))>0x7f800000)) return 0x80000000;
  if (e<0) return 0;
  if (((uf>>31)&1)&0x1){
